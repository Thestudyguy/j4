$(document).ready(function () {
        ...
        if (invalid) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    localStorage.setItem('patient', 'updated');
                    location.reload();
                },
                error: function (jxHR, err, stat) {
                    console.log(jxHR.message);
                    $('.update-pbi-loader').addClass('visually-hidden');
                    Swal.fire({
                icon: 'warning',
                title: 'Fatal',
    ...
    if(localStorage.getItem('patient') === 'updated'){
         Swal.fire({
                icon: 'success',
