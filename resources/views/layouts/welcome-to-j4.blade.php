<div class="welcome-to-j4-banner p-5" id="welcome-to-j4">
    <div class="container">
        <div class="row">
            <div class="col-sm-6 welcome-to-j4-div-img">
                <img class="float-end" src="{{ asset('/images/clinic6.jpg') }}" alt="" style="width: 75%;">
            </div>
            <div class="col-sm-6 d-flex align-items-start justify-content-center flex-column">
                <div class="welcome-card-title fw-bold text-lg text-dark">
