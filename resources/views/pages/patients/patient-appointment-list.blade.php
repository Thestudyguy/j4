        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                ...
                <div class="card-footer bg-light fw-bold d-flex justify-content-between">
                    Sub Total:
                    <span>₱{{ number_format($patientForecastPayment, 2) }}</span>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                       @forelse($prepAppointment->where('status', 'completed') as $appointment)
    <li class="list-group-item d-flex justify-content-between align-items-center">
        {{ $appointment->service }}
        <span class="badge bg-success rounded-pill">
            ₱{{ number_format($appointment->price, 2) }}
...
@empty
    <li class="list-group-item text-muted">No completed services availed.</li>
@endforelse
                    </ul>
                </div>
                <div class="card-footer bg-light fw-bold d-flex justify-content-between">
