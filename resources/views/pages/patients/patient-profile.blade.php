...
@section('content')
    ...
    <div class="text-center mt-4">
        <button type="submit" class="btn btn-success" id="confirm-appointment-btn">Confirm Appointment</button>
    </div>
...
@if (Auth::check() && Auth::user()->is_setup_complete && !Auth::user()->is_first_login && Auth::user()->Role === 'patient')
    <div class="container text-center py-5">
        <h3 class="text-success">You have already completed your setup!</h3>
        <p class="text-muted">Thank you for setting up your account. You can now view your appointments and other services.</p>
    </div>
@endif
