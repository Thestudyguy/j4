<div class="modal fade" id="delete-category-{{ $cat->id }}" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-0 border-danger border-2">
            <div class="modal-header bg-danger text-white">
                <h4 class="fw-bold m-0">⚠️ Remove Category</h4>
    ...
    <button type="button" class="btn btn-danger fw-bold delete-cat" data-id="{{ $cat->id }}">
        Remove
    </button>
