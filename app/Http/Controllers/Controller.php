...
public function ResendCode(Request $request)
{
        ...
        try {
            ...
            $appt = DB::table('appointments')->where('appointments.doctor_id', $id)
                ...
                ->select(
                    ...
                    'appointments.*',
                    'patient_info.id as ptID',
                    'patient_info.*',
                    'sub_services.id as serviceID',
                    'sub_services.*'
                )
                ->get();
        ...
        try {
            ...
            $updatedBilling = DB::table('billings')
                ...
                ->select(
                    ...
                    'inventories.price as itemPrice'
                )
                ->get();
        ...
        try {
            ...
            foreach ($items as $item) {
                ...
                if ($inventory->on_hand < $item['quantity']) {
                    ...
                    return response()->json([
                        'success' => false,
                        'message' => "Not enough stock for {$inventory->item_name}.",
    ...
    public function EditInventoryItems(Request $request)
    {
        try {
            DB::beginTransaction();
        } catch (\Throwable $th) {
